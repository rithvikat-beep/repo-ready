...
/* ── Theme Toggle ───────────────────────────────────────────── */
// Apply saved theme to body immediately to avoid flash on load
if (localStorage.getItem('rr_theme') === 'light') document.body.classList.add('light');
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (pill) {
    if (document.body.classList.contains('light')) pill.classList.add('active');
